...
def solve():
    ...
    for _ in range(t):
        try:
            ...
            # Logic Analysis:
            # 1. Alice moves first. She wants to pick an exclusive game to avoid ending the game.
            # 2. Bob moves second. He also wants to pick an exclusive game.
            # 3. They will trade exclusive moves until one runs out.
            # 4. If a player runs out of exclusives, they are forced to pick a common game,
            #    which immediately ends the game (since the other player likes it too).
            
            if k_a > k_b:
                # Alice has more exclusives. 
                # They play 2 * k_b exclusive moves (exhausting Bob's exclusives).
                # Alice plays 1 more exclusive move.
                # Bob is then forced to play a common game.
                ans = 2 * k_b + 2
            else:
                # Bob has equal or more exclusives.
                # They play 2 * k_a exclusive moves (exhausting Alice's exclusives).
